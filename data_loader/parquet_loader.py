...
class ParquetLoader(DataLoader):
    ...
    def load(self, path: str, **kwargs) -> LoadedData:
        ...
        filter_relation = kwargs.get("filter_relation", None)
        ...
        for fpath in parquet_files:
            ...
            for gi in range(pf.metadata.num_row_groups):
                ...
                for row in tbl.to_pylist():
                    ...
                    if filter_relation and rel != filter_relation:
                        skipped_relation += 1
                        continue
        ...
        logger.info(
            ...
            f"in {elapsed:.2f}s "
            f"(skipped: {skipped_non_en} non-en, {skipped_relation} filtered)"
        )
        ...
        metadata = {
            ...
            "skipped_filtered": skipped_relation,
